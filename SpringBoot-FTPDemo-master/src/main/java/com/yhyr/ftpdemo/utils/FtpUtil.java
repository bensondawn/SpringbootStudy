...
public class FtpUtil {
    ...
    public boolean uploadFile(FTPClient ftpClient, String remoteDirPath, String remoteFileName, InputStream inputStream) {
        logger.info("Begin upload file: {} to FTP: {}/{}", remoteDirPath, remoteFileName);
//        FileInputStream inputStream = null;
        try {
//            inputStream = new FileInputStream(new File(uploadFilePath));
            createRemoteDirecroty(ftpClient, remoteDirPath);
            ...
            logger.info("Upload file: {} Failed", remoteFileName);
